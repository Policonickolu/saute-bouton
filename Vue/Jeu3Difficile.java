...
/**
 * Jeu "Bouton Filant" Difficile.
 * Hérite de "Jeu".
*
* @author COULIDIATI Donald
* @author BEN YAHIA Heidy
*/
public class Jeu3Difficile extends Jeu{
	...
	public Jeu3Difficile(ControleurSauteBouton controleur, MeilleursScores score) {
		
		super(controleur,score.getJeu3().getScoreDifficile().getTemps());
