...
/**
 * Jeu "Bouton Filant" Facile.
 * Hérite de "Jeu".
*
* @author COULIDIATI Donald
* @author BEN YAHIA Heidy
*/
public class Jeu3Facile extends Jeu{
	...
	public Jeu3Facile(ControleurSauteBouton controleur, MeilleursScores score) {
		
		super(controleur,score.getJeu3().getScoreFacile().getTemps());
