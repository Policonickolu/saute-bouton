...
*/
public class Jeu2Difficile extends Jeu{
	...
	public Jeu2Difficile(ControleurSauteBouton controleur, MeilleursScores score) {
		
		super(controleur,score.getJeu2().getScoreDifficile().getTemps());
		...
		b2.addActionListener(new MauvaisClickListener());
		
		b3 = new JButton("b3");
		b3.setFocusable(false);
		b3.addActionListener(new MauvaisClickListener());
		
		b4 = new JButton("b4");
		b4.setFocusable(false);
		b4.addActionListener(new MauvaisClickListener());
	 ...
	 * Chaque clic sur le mauvais bouton fait changer les boutons de position sans gagner.
	 * Chaque clic sur à coté fait changer les boutons de position sans gagner.
	 */
	public class ClickListener extends Thread implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(this.compteur==16){
				...
				jeu.addMouseListener(new MauvaisClickListener());
			}
			// Le compteur diminue
			this.compteur--;
	 ...
	 * Chaque clic sur à coté fait changer les boutons de position sans gagner.
	 */
	public class MauvaisClickListener implements ActionListener, MouseListener{
		...
		public void action(){
			...
			// Procédure empêchant la superposition des boutons.
			int width1 = b1.getWidth();
			int height1 = b1.getHeight();
			int x1 = (int) (Math.random() * (600 - width1));
			int y1 = (int) (Math.random() * (600 - height1));
