...
/**
 * Jeu "Bon Bouton" Moyen.
 * Hérite de "Jeu".
*
* @author COULIDIATI Donald
* @author BEN YAHIA Heidy
*/
public class Jeu2Moyen extends Jeu{
	...
	public Jeu2Moyen(ControleurSauteBouton controleur, MeilleursScores score) {

		super(controleur,score.getJeu2().getScoreMoyen().getTemps());
	...
	/**
	 * 
	 * En cas de mauvais clic, les boutons sautent sans que les équations ne changent ou qu'il y ait de point gagné.
	 *
	 */
	public class MauvaisClickListener implements ActionListener{
